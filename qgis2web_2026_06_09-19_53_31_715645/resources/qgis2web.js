...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32749',
            //extent: [605312.405277, 9076505.983202, 662905.173393, 9123547.134790],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([613639.422162, 9082880.245700, 647660.086036, 9107769.270706], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_PenggunaanLahanKabupatenBlitar_1,
    colName: 'Klasifikas',
    zoom: 10,
    collapsed: true,
    map: map,
